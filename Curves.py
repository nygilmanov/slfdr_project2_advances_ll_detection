...
# feed in previous fits
def search_around_poly(binary_warped,left_fit,right_fit):
    
    ## we take left_fit and right fit from the previous approach with sliding windows
    ...
    # Find all values taht fall into line +/- margin region 
    leftx = nonzerox[left_lane_inds]
    lefty = nonzeroy[left_lane_inds] 
    rightx = nonzerox[right_lane_inds]
    righty = nonzeroy[right_lane_inds]
    ...
    # Fit new polynomials
    left_fitx, right_fitx,ploty,left_fit0,right_fit0, = fit_poly(binary_warped.shape, leftx, lefty, rightx, righty)
    

    #print('CATCH IT LEFT',left_fit0)
    #print('CATCH IT RIGHT',right_fit0)
    ...
    return result,left_fitx,right_fitx,ploty, left_fit0,right_fit0
...
def measure_curvature_pixels(left_fit,right_fit,ploty):
    ...
    #print('Calucalte radius at point',y_eval)
...
def get_last_6_poly():
    ...
    #print('Final left',left_fin,right_fin)
